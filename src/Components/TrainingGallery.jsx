...
// Imports remain consistent with your existing structure
import Training1 from "../assets/Training/T4.jpeg";
import Training2 from "../assets/Training/T10.jpeg";
import Training3 from "../assets/Training/t16.jpeg";
import Training4 from "../assets/Training/T5.jpeg";
...
const trainingPhotos = [
  ...
  {
    src: Training2,
    // Taking full width on mobile for better visibility
  ...
  return (
    <section className="py-16 md:py-24 bg-[#05102a] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        ...
        {/* 8-Photo Bento Grid: Optimized for Mobile Visibility */}
        {/* Increased  grid grid-cols-2 md:grid-cols-12 auto-rows-min md:auto-rows-[200px] gap-4 */}
        <div className="grid grid-cols-2 md:grid-cols-12 auto-rows-[min] md:auto-rows-[200px] gap-4 md:gap-4">
          {trainingPhotos.map((photo, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0, y: 20 }}
